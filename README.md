Cursed Age
Cursed Age is a custom Jujutsu Kaisen-inspired Minecraft mod, purpose-built to power the Cursed Age server — adding new Cursed Techniques, progression systems, and factions on top of the Sorcery Age mod.
...
Your starting Cursed Energy is also rolled: most players land Moderate, some get Lesser or Greater, and a rare few roll Immense — which comes with its own perks (see Grading Up).
---
Cursed Techniques
...
Death Painting Blood Bottle — Blood extracted from a Death Painting. Splash it, throw a lingering cloud of it, or tip your arrows with it to infect enemies with the Mixed Blood effect (see Effects).
Blocks:
...
`/faction ...`	Manage your faction (see Factions)
...
---
Got questions, found a bug, or have an idea for a new technique? Reach out on the server — Cursed Age is always evolving.
